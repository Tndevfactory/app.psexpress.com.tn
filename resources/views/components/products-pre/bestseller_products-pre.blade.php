<h2 class='mt-5 mb-3 bg-warning text-dark  py-2 text-center text-uppercase fs-5'>  {{ __('Meilleures ventes') }} </h2>
...
<div class="row row-cols-2 row-cols-md-5 gx-2 gy-4">
  ...
  <div class="col">
    <div class="card card-product h-100 shadow-sm position-relative">
      ...
      <div class="px-2 position-relative  pb-2">
          ...
          <div class='buy-button-div d-none d-md-flex justify-content-center gap-5  bg-white' >

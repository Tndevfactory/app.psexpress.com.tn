...
<h2 class='mt-5 mb-3 bg-warning text-dark  py-2 text-center text-uppercase fs-5'>  {{ __('Similar Products') }} </h2>

<div class="row row-cols-2 row-cols-md-5 gx-2 gy-4 mt-2">
  ...
  <div class="col">
    <div class="card card-product h-100 shadow-sm position-relative">
     ...
     <img src="{{ asset(isset($product->photo1 ) ? $product->photo1  : 'media/products/void.webp')}}"
